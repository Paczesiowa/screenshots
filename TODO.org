* nigdy nie rzucace argparse.argumenttypeerror
* przejrzec inne funkcje jak non_negative_int
* in _compat should only stay thing that are used in dom2img/*
* add page debugging support to render_file.phantom.js
* catching sigkill/sigint
